<script>
    ...
    $: selectedProduct = $inventoryStore.products.find(p => p.id === parseInt(productId));
    ...
    function reset() {
        productId = ''; movementType = 'Entrada'; quantity = 1; notes = '';
    }
</script>
...
<div class="card form-container">
    ...
    <form class="movement-form" on:submit|preventDefault={handleSubmit}>
        ...
        <div class="field">
            ...
            <textarea id="notes" bind:value={notes} placeholder="Ej: Recepción de pedido #45 ..."></textarea>
        </div>
