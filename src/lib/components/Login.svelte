    ...
    {:else if registrationSuccess}
      <div class="success-banner" transition:fade>
        ...
        <div class="success-text">
          ...
          <p>
            Te hemos enviado un correo de confirmación. Por favor, <strong
              >revisa tu bandeja de entrada o la carpeta de Spam</strong
            > y haz clic en el enlace para verificar tu cuenta antes de iniciar sesión.
          </p>
        </div>
        <button
          class="small-btn"
        ...
        {#if !isReset}
          <div class="input-group">
            <div class="label-row">
              ...
              {#if isLogin}
                <button type="button" class="link-btn" on:click={toggleReset}
